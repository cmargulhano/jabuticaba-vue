"""
Django settings for jaboticaba project.
...
WSGI_APPLICATION = 'jaboticaba.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './jaboticaba.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
